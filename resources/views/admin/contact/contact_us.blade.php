                            ...
                            <div class="col-sm-6 b-r">
                                ...
                                <form role="form" action="{{route('contactUs.store')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>address</label>
                                        <input type="address" placeholder="Enter address" class="form-control" name="address">
                                    </div>
                                    <div class="form-group">
                                        <label>phone</label>
                        ...
                        <table class="table">
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td>{{$contact->email}}</td>
                                    <td>
                                        <form action="{{ route('contactUs.destroy',$contact->id)}}" method="POST" onsubmit="return confirm('Are you sure you want to unenroll?');" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
